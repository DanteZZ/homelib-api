...
export const errors = {
    ru_RU: {
        ...
        category: {
            update: "Произошла ошибка при сохранении категории",
            not_found: "Категория не найдена"
        },
        cover: {
            update: "Произошла ошибка при сохранении вида переплёта",
            not_found: "Вид переплёта не найдена"
        },
        friend: {
            update: "Произошла ошибка при сохранении друга",
            not_found: "Друг не найден"
        },
        language: {
            update: "Произошла ошибка при сохранении языка",
            not_found: "Язык не найден"
        },
        publisher: {
            update: "Произошла ошибка при сохранении издателя",
            not_found: "Издатель не найден"
        },
        review: {
            update: "Произошла ошибка при сохранении заметки",
            not_found: "Заметка не найдена"
        },
        handover: {
            update: "Произошла ошибка при сохранении передачи книги",
            not_found: "Передача книги не найдена"
        }
    }
}
